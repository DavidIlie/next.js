...
/// A unit of garbage-collection work fed through the unbounded parallel pool in
...
///
/// (A single-variant enum today; kept as an enum so the unbounded pool's job type has room to
